...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
  ...
  <ul class="nav flex-column">
    ...
    <li class="nav-item">
      <a class="nav-link active text-white" href="user_resolved_issues.php">
      ...
      <a class="nav-link text-white" href="user_panel.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="section-heading mb-4">
                <u>My Resolved Issues</u>
            </div>

   

            <!-- RESOLVED -->
   <?php if ($resolved_issues->num_rows > 0): ?>
...
<?php else: ?>
       <div class="card mb-4">
        <div class="card-body">
            <p class="fs-4">No resoolved issues.</p>
        </div>
    </div>
<?php endif; ?>
