...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
  ...
  <ul class="nav flex-column">
    ...
    <li class="nav-item">
      <a class="nav-link active text-white" href="user_pending_issues.php">
        <i class="bi bi-hourglass-top"></i> Pending Issues
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-white" href="user_approved_issues.php">
      ...
      <a class="nav-link text-white" href="user_panel.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="section-heading mb-4">
                <u>My Pending Issues</u>
            </div>

            <!-- PENDING -->
   <?php if ($pending_issues->num_rows > 0): ?>
    <?php while ($issue = $pending_issues->fetch_assoc()):
...
<?php else: ?>
       <div class="card mb-4">
        <div class="card-body">
            <p class="fs-4">No pending issues.</p>
        </div>
    </div>
<?php endif; ?>
