...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] === UPLOAD_ERR_OK) {
        $upload_dir = 'users/profile_pictures/';
        ...
        $stmt->bind_param("ssssi", $name, $phone, $address, $file_path, $user_id);
    } else {
...
<head>
  <meta charset="UTF-8">
  <title>User Profile - Solve360</title>
  <!-- AOS CSS -->
...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
      ...
      <hr class="text-white">
      <li><a href="user_profile.php" class="nav-link bg-primary text-white"><i class="bi bi-person-circle me-2"></i> Profile</a></li>
      <hr class="text-white">
  ...
  <div class="profile-wrapper">
    <div class="transparent-box"data-aos="fade-left">
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <img id="profilePreview" src="<?= htmlspecialchars($user['profile_picture'] ?: 'default.png') ?>" class="profile-picture mb-2" alt="Profile Picture">
          <hr>
