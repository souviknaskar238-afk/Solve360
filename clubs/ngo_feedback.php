...
<head>
  <meta charset="UTF-8">
  <title>View NGO Feedback | Solve360</title>
...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
 ...
 <ul class="nav nav-pills flex-column mb-auto">
    ...
    <hr class="text-white">
    <li>
      <a href="ngo_feedback.php" class="nav-link bg-primary text-white">
...
<script>
  document.querySelectorAll('#ngoStars i').forEach((star, idx) => {
    star.addEventListener('click', function () {
      document.querySelectorAll('#ngoStars i').forEach(s => s.classList.remove('selected'));
      for (let i = 0; i <= idx; i++) {
        document.querySelectorAll('#ngoStars i')[i].classList.add('selected');
      }
