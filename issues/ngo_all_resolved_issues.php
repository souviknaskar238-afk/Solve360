...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
  <h4 class="text-white mb-4">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="../clubs/assigned_issues.php">
                    <i class="bi bi-clipboard-check"></i> Assigned Issues
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="../clubs/resoloved_issues.php">
                    <i class="bi bi-award-fill"></i> Resolved Issues
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../clubs/contact_admin.php">
                    <i class="bi bi-person-lines-fill"></i>Contact Admin
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="ngo_all_resolved_issues.php">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../clubs/ngo_panel.php">
