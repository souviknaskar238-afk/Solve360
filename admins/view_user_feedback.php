...
<head>
  <meta charset="UTF-8">
  <title>View User Feedback | Solve360</title>
...
<div class="collapse d-md-block col-md-3 col-lg-2  sidebar p-3" id="userSidebar">
  ...
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
      <a href="view_user_feedback.php" class="nav-link bg-primary text-white">
 ...
 <li>
  ...
  <div class="container mt-5">
    <h3 class="mb-4 text-center text-white"><u>User Feedback</u></h3>
